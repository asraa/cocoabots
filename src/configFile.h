...
#define PARTICLE_FILTER_STANDARD_DEVIATION_ULTRASONIC 20
#define PARTICLE_FILTER_STANDARD_DEVIATION_IR 8
#define PARTICLE_FILTER_MAX_IR_RANGE 30
#define PARTICLE_FILTER_MAX_ULTRASONIC_RANGE 80
#define PARTICLE_FILTER_UPDATE_RATE_MS 50

#define PARTICLE_FILTER_STD_DEVIATION_X_RESPAWN 0.2
#define PARTICLE_FILTER_STD_DEVIATION_Y_RESPAWN 0.2
#define PARTICLE_FILTER_STD_DEVIATION_ANGLEE_RESPAWN 1
#define PARTICLE_FILTER_NUMBER_OF_PARTICLES_RESPAWN 10 // < initial/2
#define PARTICLE_FILTER_RESAMPLE_RESPAWN_RATIO 1
#define PARTICLE_FILTER_KILL_PROBABILITY_THRESHOLD 0.000001
