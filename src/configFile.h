...
#define FOLLOW_POINT_UPDATE_RATE_MS 2000
...
#define PARTICLE_FILTER_MAX_IR_RANGE 25
#define PARTICLE_FILTER_MAX_ULTRASONIC_RANGE 35
#define PARTICLE_FILTER_UPDATE_RATE_MS 50

#define PARTICLE_FILTER_STD_DEVIATION_X_RESPAWN 3
#define PARTICLE_FILTER_STD_DEVIATION_Y_RESPAWN 3
#define PARTICLE_FILTER_STD_DEVIATION_ANGLEE_RESPAWN 45
#define PARTICLE_FILTER_NUMBER_OF_PARTICLES_RESPAWN 40 // < initial/2
#define PARTICLE_FILTER_RESAMPLE_RESPAWN_RATIO 3
