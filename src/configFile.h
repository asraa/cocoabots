...
#define PARTICLE_FILTER_STANDARD_DEVIATION_ULTRASONIC 5
#define PARTICLE_FILTER_STANDARD_DEVIATION_IR 3
#define PARTICLE_FILTER_MAX_IR_RANGE 20
...
#define PARTICLE_FILTER_NUMBER_OF_PARTICLES_RESPAWN 20 // < initial/2
