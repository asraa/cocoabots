...
#define GO_TO_POINT_TURNING_TIMEOUT_MS 7000
...
#define TURN_N_DEGREES_SLOWLY_TIMEOUT_MS 7000
...
#define PARTICLE_FILTER_UPDATE_RESAMPLE_RATIO 4 // If we resample too often, we lose variance.
...
#define PARTICLE_FILTER_STANDARD_DEVIATION_IR 4
#define PARTICLE_FILTER_MAX_IR_RANGE 30
#define PARTICLE_FILTER_MAX_ULTRASONIC_RANGE 35
#define PARTICLE_FILTER_UPDATE_RATE_MS 50

#define PARTICLE_FILTER_STD_DEVIATION_X_RESPAWN 2
#define PARTICLE_FILTER_STD_DEVIATION_Y_RESPAWN 2
#define PARTICLE_FILTER_STD_DEVIATION_ANGLEE_RESPAWN 20
#define PARTICLE_FILTER_NUMBER_OF_PARTICLES_RESPAWN 30 // < initial/2
#define PARTICLE_FILTER_RESAMPLE_RESPAWN_RATIO 5
#define PARTICLE_FILTER_KILL_PROBABILITY_THRESHOLD 0.001
