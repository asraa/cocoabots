...
#define PARTICLE_FILTER_ENCODERS_NORMALIZED_STANDARD_DEVIATION 0.05
#define PARTICLE_FILTER_ANGLE_NORMALIZED_STANDARD_DEVIATION 0.07
...
#define PARTICLE_FILTER_UPDATE_RESAMPLE_RATIO 100 // If we resample too often, we lose variance.
