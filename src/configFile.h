...
#define MINIMUM_THRESHOLD_PWM (0.055 / MAXIMUM_NORMALIZED_SAFE_SPEED_MOTORS) //Minimum pwm to move the motor at 1 safe factor
...
#define FOLLOW_POINT_PRECISION_INCHES 0.8
#define FOLLOW_POINT_PRECISION_ANGLE 2.1
