...
#define PARTICLE_FILTER_STD_DEVIATION_X_RESPAWN 4
#define PARTICLE_FILTER_STD_DEVIATION_Y_RESPAWN 4
#define PARTICLE_FILTER_STD_DEVIATION_ANGLEE_RESPAWN 30
#define PARTICLE_FILTER_NUMBER_OF_PARTICLES_RESPAWN 30 // < initial/2
#define PARTICLE_FILTER_RESAMPLE_RESPAWN_RATIO 7
