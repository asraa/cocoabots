...
#define PARTICLE_FILTER_STD_DEVIATION_X_RESPAWN 0.5
#define PARTICLE_FILTER_STD_DEVIATION_Y_RESPAWN 0.5
...
#define PARTICLE_FILTER_KILL_PROBABILITY_THRESHOLD 0.00001
