...
#define FWD_ERROR_GAIN 1    //Should be positive
#define FWD_SPEED_GAIN -10  //Should be negative
#define ANG_ERROR_GAIN 1
#define ANG_SPEED_GAIN -10  //Should be negative
#endif // CONFIGFILE_H
